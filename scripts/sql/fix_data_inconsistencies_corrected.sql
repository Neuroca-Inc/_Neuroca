-- =====================================================================
-- CORRECTED DATA INCONSISTENCY FIXES
-- =====================================================================
-- This script addresses the logical inconsistencies identified in the database
-- Fixed version without audit_log references and GREATEST function
-- =====================================================================

SELECT 'CORRECTED DATA INCONSISTENCY FIXES' as section
UNION ALL
...
SET effort_hours = CASE component_name
    ...
    ELSE CASE WHEN effort_hours < 8 THEN 8 ELSE effort_hours END  -- SQLite compatible minimum
END,
updated_at = CURRENT_TIMESTAMP
WHERE component_id IN (
    SELECT c.component_id 
...
-- Phase 7: Create Issues for Newly Identified Critical Problems
-- =====================================================================
...
SELECT 'CORRECTED DATA INCONSISTENCY FIXES COMPLETE' as completion_status, 
