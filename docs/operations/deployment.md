...
Use `docker-compose.agent.yml` to run a resilient, production‑like stack with Postgres and the Neuroca API. For more complex stacks, customize the compose file or migrate to Kubernetes.
